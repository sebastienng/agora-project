...
function TermsOfUse() {
    return (
      <div>
        <h2>Agra Website Terms of Use</h2>

        <p>
          The Agora - Freelance Solution website located at Agora.com is a
          copyrighted work belonging to Agora. Certain features of the Site may
        ...
        <p>
          ...
          Agora - Freelance Solution uses ‘cookies’. These cookies are used to
        ...
        <p>
          ...
          the Company should be sent to: 3 rue Malher , Paris 75004 France .
        ...
        <p>Address: 3 rue Malher , Paris 75004 France </p>
      </div>
    );
}
